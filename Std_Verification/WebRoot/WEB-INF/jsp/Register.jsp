...
<!-- Modal Form -->
   ...
   <h6 style="color:Green; text-align: center;">
        ...
        <div class="form-group">
			<div class="row">
				<div class="col">
				<input type="text" class="form-control" name="firstName" id="firstName" placeholder="First Name" required="required"></div>
				<div class="col">
				<input type="text" class="form-control" name="lastName" id="lastName" placeholder="Last Name" required="required"></div>
			</div>        	
        </div> 
		...
		<div class="form-group">
            ...
            <button onclick="registerUser();" type="button"  class="btn btn-success btn-lg btn-block">Register Now</button>
            </div>
        </div>
        
        <div class="text-center">Already have an account?<a href="LoginPage.jsp">Sign in</a></div>
